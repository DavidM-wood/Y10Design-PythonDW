...
# for loop 
# the word for is used to indicated that it is happening for x many times
# range tells how many times it has to do it 


# let's add all of the numbers from 1 to 100
# total will keep track of the sum of the numbers as they are added
total = 0
